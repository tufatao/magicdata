            ...
            <div class="row">
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                        ...
                        <li><i class="fa fa-indent"></i>客户详情</li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    ...
                    <form action="<%=basePath%>cusAction!addCus" method="post">
                        ...
                        <div class="panel-heading">
                            <h2><i class="fa fa-indent red"></i><strong>客户详情</strong></h2>
                        </div>
                        ...
                        <div class="form-group col-lg-8 col-lg-offset-1">
                                    <label for="text-input">名称</label>
				                        ...
				                        <input type="text" id="username" value="${cus.name}" name="name" class="form-control" placeholder="Username">
				                    </div>
				                    </div>
                                <div class="form-group col-lg-8 col-lg-offset-1">
                                    <label for="text-input">公司</label>
                                    <input type="text" id="text-input" value="${cus.company}" name="company" class="form-control" placeholder="输入分组名">
                                </div>
                                ...
                                <div class="input-group">
									  ...
									  <input type="text" id="phone" value="${cus.phone}" name="phone" class="form-control">
									</div>
                                </div>
                                <div class="form-group col-lg-8 col-lg-offset-1">
                                ...
                                <div class="input-group">
				                        ...
				                        <input type="email" id="email" value="${cus.email}" name="email" class="form-control" placeholder="Email address">
				                    </div>
                                </div>
                                <div class="form-group col-lg-8 col-lg-offset-1">
                                    <label for="text-input">简介</label>
                                    <input type="text" id="text-input" value="${cus.brief}" name="brief" class="form-control" placeholder="输入分组名">
                                </div>
                                <div class="form-group col-lg-8 col-lg-offset-1">
                                    <label for="text-input">CusRegex</label>
                                    <input type="text" id="text-input" value="${cus.cusRegex}" name="cusRegex" class="form-control" placeholder="输入分组名">
                                </div>
                                <div class="form-group col-lg-8 col-lg-offset-1">
                                    <label for="text-input">联系人</label>
                                    <input type="text" id="text-input" value="${cus.cantact}" name="contact" class="form-control" placeholder="输入分组名">
                                </div>
                                <div class="form-group col-lg-8 col-lg-offset-1">
