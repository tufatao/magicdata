                            ...
                            <table class="table table-striped table-bordered bootstrap-datatable datatable">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-success" href="<%=basePath%>testSpiderAction!taskTest?tid=${task.tid}">
                                            <i class="fa fa-search-plus "></i>
                                        </a>
                                        <a class="btn btn-info" href="<%=basePath%>taskAction!toTaskDetail?tid=${task.tid}">
                                            <i class="fa fa-edit "></i>
                                        </a>
                                        <a class="btn btn-success" href="<%=basePath%>testSpiderAction!toPointKey?tid=${task.tid}">
                                            <i class="fa fa-search-plus "></i>
                                        </a>
