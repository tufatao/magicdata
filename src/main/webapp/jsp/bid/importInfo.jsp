            ...
            <div class="row">
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                        ...
                        <li><i class="fa fa-indent"></i>导入数据</li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h2><i class="fa fa-indent red"></i><strong>导入数据</strong></h2>
                        </div>
                        <div class="panel-body">
                            <form action="<%=basePath%>bidAction!importInfo" method="post">
                                <div class="form-group">
                                    <div class="input-group col-lg-8">
                                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                        <input type="text" id="minDate" onclick="WdatePicker()" name="minDate" class="form-control" placeholder="开始时间">
                                    </div>
                                </div>
                                <div class="form-group col-lg-5">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                        <input type="text" id="maxDate" onclick="WdatePicker()" name="maxDate" class="form-control" placeholder="结束时间">
                                    </div>
                                </div>

                                <div class="form-group form-actions">
                                    <button type="submit" class="btn btn-sm btn-success btn-tou"> 开始导入</button>
                                </div>
                            </form>
                        </div>
                    </div>
