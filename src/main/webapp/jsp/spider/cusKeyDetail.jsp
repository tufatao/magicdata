        ...
        <div id='content-mid'>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <form action="<%=basePath%>cusAction!updateCusKey" method="post">
                        
                        <div class="panel-heading">
                            <h2><i class="fa fa-indent red"></i><strong>关键字详情</strong></h2>
                        </div>
                        <div class="panel-body">
                        <input type="hidden" id="text-input" name="ckid" value="${cusKey.ckid}">
                        <div class="form-group">
                                ...
                                <div class="form-group col-lg-8 col-lg-offset-1">
                                    ...
                                    <input type="text" id="text-input" name="name" value="${cusKey.bidKeyword.name}" class="form-control" placeholder="输入分组名">
                                </div>
                                <div class="form-group col-lg-8 col-lg-offset-1">
                                ...
                                <div class="form-group col-lg-8 col-lg-offset-1">
                                    ...
                                    <textarea id="textarea-input" name="brief" value="${cusKey.brief}" rows="3" class="form-control" placeholder="输入简单描述"></textarea>
