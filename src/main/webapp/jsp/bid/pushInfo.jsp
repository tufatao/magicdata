            ...
            <div class="row">
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                        ...
                        <li><i class="fa fa-indent"></i>平台推送</li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h2><i class="fa fa-table red"></i><span class="break"></span><strong>平台推送列表</strong></h2>
                        ...
                        <button type="button" class="btn btn-sm btn-success btn-tou" 
                             onclick="javascript:window.location.href='<%=basePath%>bidAction!pushInfo'">
                             <i class="fa fa-dot-circle-o"></i> 推送</button>
                            </div>
                    </div>
                </div>
            </div>
