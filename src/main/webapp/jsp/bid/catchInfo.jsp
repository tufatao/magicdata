            ...
            <div class="row">
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                        ...
                        <li><i class="fa fa-indent"></i>抓取信息</li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form action="<%=basePath%>bidAction!catchInfo" method="post">
                                <div class="form-group">
                                    <div class="input-group col-lg-8">
                                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                        <input type="text" id="minDate" onclick="WdatePicker()" name="catchFrom" class="form-control" placeholder="开始时间">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="input-group col-lg-5">
                                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                        <input type="text" id="maxDate" onclick="WdatePicker()" name="catchTo" class="form-control" placeholder="结束时间">
                                    </div>
                                </div>
