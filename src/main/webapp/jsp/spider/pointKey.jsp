            ...
            <div class="row">
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                        ...
                        <li><i class="fa fa-list-alt"></i><a href="#">任务测试</a></li>
                        <li><i class="fa fa-indent"></i>Step1:指定关键字</li>
                    </ol>
                </div>
            </div>
                    ...
                    <form action="<%=basePath%>testSpiderAction!processTask" method="post">
                        ...
                        <div class="form-group col-lg-8 col-lg-offset-1">
                                ...
                                <div class="form-group col-lg-8 col-lg-offset-1">
                                    ...
                                    <input type="text" id="text-input" name="name" class="form-control" placeholder="输入关键字">
                                </div>
                                

                        </div>
                        <div class="panel-footer">
                            <button type="submit" class="btn btn-sm btn-success btn-tou"><i class="fa fa-dot-circle-o"></i> 提交</button>
