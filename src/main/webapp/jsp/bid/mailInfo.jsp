            ...
            <div class="row">
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                        ...
                        <li><i class="fa fa-list-alt"></i><a href="#">推送管理</a></li>
                        <li><i class="fa fa-indent"></i>邮件推送</li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h2><i class="fa fa-indent red"></i><strong>设置时间区间</strong></h2>
                        </div>
                        <div class="panel-body">
                            <form action="<%=basePath%>bidAction!getMailParams" method="post">
                                <div class="form-group">
                                    <div class="input-group col-lg-8">
                                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                        <input type="text" id="minDate" onclick="WdatePicker()" name="mailFrom" class="form-control" placeholder="开始时间">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="input-group col-lg-5">
                                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                        <input type="text" id="maxDate" onclick="WdatePicker()" name="mailTo" class="form-control" placeholder="结束时间">
                                    </div>
                                </div>

                                <div class="form-group form-actions">
                                    <button type="submit" class="btn btn-sm btn-success btn-tou"> 推送邮件</button>
                                </div>
                            </form>
                        </div>
                    </div>
