                ...
                <div class="col-lg-12">
                    ...
                    <form action="<%=basePath%>taskAction!addFilter" method="post">
                        ...
                        <div class="form-group col-lg-8 col-lg-offset-1">
                                    ...
                                    <input type="text" id="text-input" name="name" value="${filter.name}" class="form-control" placeholder="输入分组名">
                                </div>
                                <div class="form-group col-lg-8 col-lg-offset-1">
								  ...
								  <div class="controls">
									<div class="input-group">
										...
										<input type="text" id="text-input" name="titleRegex" value="${filter.titleRegex}" class="form-control" placeholder="输入分组名">
									</div>	
								  </div>
								</div>
                                <div class="form-group col-lg-8 col-lg-offset-1">
								  ...
								  <div class="controls">
									<div class="input-group">
										...
										<input type="text" id="text-input" name="conRegex" value="${filter.contentRegex}" class="form-control" placeholder="输入分组名">
									</div>	
								  </div>
								</div>
								<div class="form-group col-lg-8 col-lg-offset-1">
								  ...
								  <div class="controls">
									<div class="input-group">
										...
										<input type="text" id="text-input" name="pubDateRegex" value="${filter.publishdateRegex}" class="form-control" placeholder="输入分组名">
									</div>	
								  </div>
								</div>
								<div class="form-group col-lg-8 col-lg-offset-1">
