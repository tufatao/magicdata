...
<head>
    ...
    <script type="text/javascript">
        ...
        function toPrevious(){
            document.location.href="<%=basePath%>cusAction!cusPaging?pageMethod=previous&currentPage=${currentPage}";
        }
        function toNext(){
            document.location.href="<%=basePath%>cusAction!cusPaging?pageMethod=next&currentPage=${currentPage}";
        }
        function toEnd(){
            document.location.href="<%=basePath%>cusAction!cusPaging?pageMethod=last&currentPage=${currentPage}";
        }
        function toWhere(toPage){
            document.location.href="<%=basePath%>cusAction!cusPaging?pageMethod=refresh("+toPage+")&currentPage="+toPage;
        }
    </script>
                        ...
                        <div class="panel-body">
                            <table class="table table-striped table-bordered bootstrap-datatable datatable">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-success" href="<%=basePath%>cusAction!cusKeys?cusid=${cus.cusid}">
                                            <i class="fa fa-search-plus ">MyKeys</i>
                                        </a>
                                        <a class="btn btn-info" href="<%=basePath%>cusAction!toCusDetail?cusid=${cus.cusid}">
